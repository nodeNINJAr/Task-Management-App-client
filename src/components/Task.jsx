...
const Task = ({ title, desc, date, category }) => {
  return (
    <div className="bg-green-100 p-4 rounded-lg shadow-md relative">
      <div className="flex justify-between items-center mb-2">
        <h2 className="text-lg font-semibold">{title}</h2>
        <button className="bg-white text-green-500 px-3 py-1 rounded-full">Asap</button>
      </div>
      ...
      <div className="absolute bottom-0 right-0 flex space-x-2 mb-2 mr-2">
        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded">Update</button>
